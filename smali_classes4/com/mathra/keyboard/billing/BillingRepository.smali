.class public final Lcom/mathra/keyboard/billing/BillingRepository;
...
.method public static synthetic $r8$lambda$33FNiY_qNAfUXE4ZotzShZeaVPs(Lcom/android/billingclient/api/BillingResult;)V
    ...
    invoke-static {p0}, Lcom/mathra/keyboard/billing/BillingRepository;->acknowledgePurchase$lambda$0(Lcom/android/billingclient/api/BillingResult;)V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/mathra/keyboard/billing/BillingRepository;->context:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/mathra/keyboard/billing/BillingRepository;->_purchasedItems:Lkotlinx/coroutines/flow/MutableStateFlow;
    ...
    iput-object v0, p0, Lcom/mathra/keyboard/billing/BillingRepository;->purchasedItems:Lkotlinx/coroutines/flow/StateFlow;
    ...
    iput-object p1, p0, Lcom/mathra/keyboard/billing/BillingRepository;->billingClient:Lcom/android/billingclient/api/BillingClient;
    ...
    iput-object p1, p0, Lcom/mathra/keyboard/billing/BillingRepository;->scope:Lkotlinx/coroutines/CoroutineScope;

    .line 27
    invoke-direct {p0}, Lcom/mathra/keyboard/billing/BillingRepository;->startConnection()V

    return-void
.end method

.method public static final synthetic access$acknowledgePurchase(Lcom/mathra/keyboard/billing/BillingRepository;Lcom/android/billingclient/api/Purchase;)V
    .locals 0

    .line 11
    invoke-direct {p0, p1}, Lcom/mathra/keyboard/billing/BillingRepository;->acknowledgePurchase(Lcom/android/billingclient/api/Purchase;)V

    return-void
.end method

.method public static final synthetic access$getBillingClient$p(Lcom/mathra/keyboard/billing/BillingRepository;)Lcom/android/billingclient/api/BillingClient;
    .locals 0

    .line 11
    iget-object p0, p0, Lcom/mathra/keyboard/billing/BillingRepository;->billingClient:Lcom/android/billingclient/api/BillingClient;

    return-object p0
.end method

.method public static final synthetic access$getContext$p(Lcom/mathra/keyboard/billing/BillingRepository;)Landroid/content/Context;
    .locals 0

    .line 11
    iget-object p0, p0, Lcom/mathra/keyboard/billing/BillingRepository;->context:Landroid/content/Context;

    return-object p0
.end method

.method public static final synthetic access$get_purchasedItems$p(Lcom/mathra/keyboard/billing/BillingRepository;)Lkotlinx/coroutines/flow/MutableStateFlow;
    .locals 0

    .line 11
    iget-object p0, p0, Lcom/mathra/keyboard/billing/BillingRepository;->_purchasedItems:Lkotlinx/coroutines/flow/MutableStateFlow;
...
.method private final acknowledgePurchase(Lcom/android/billingclient/api/Purchase;)V
    ...
    .line 113
    iget-object v0, p0, Lcom/mathra/keyboard/billing/BillingRepository;->billingClient:Lcom/android/billingclient/api/BillingClient;

    new-instance v1, Lcom/mathra/keyboard/billing/BillingRepository$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Lcom/mathra/keyboard/billing/BillingRepository$$ExternalSyntheticLambda0;-><init>()V
...
.method private final startConnection()V
    ...
    new-instance v1, Lcom/mathra/keyboard/billing/BillingRepository$startConnection$1;

    invoke-direct {v1, p0}, Lcom/mathra/keyboard/billing/BillingRepository$startConnection$1;-><init>(Lcom/mathra/keyboard/billing/BillingRepository;)V
...
.method private final updateLocalPremiumStatus(Z)V
    ...
    iget-object v1, p0, Lcom/mathra/keyboard/billing/BillingRepository;->context:Landroid/content/Context;

    invoke-virtual {v0, v1, p1}, Lcom/mathra/keyboard/ActivationManager;->setPremiumStatus(Landroid/content/Context;Z)V
...
.method public final getPurchasedItems()Lkotlinx/coroutines/flow/StateFlow;
    ...
    .line 13
    iget-object v0, p0, Lcom/mathra/keyboard/billing/BillingRepository;->purchasedItems:Lkotlinx/coroutines/flow/StateFlow;
...
.method public final launchBillingFlow(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    .line 141
    iget-object v1, p0, Lcom/mathra/keyboard/billing/BillingRepository;->scope:Lkotlinx/coroutines/CoroutineScope;

    new-instance v0, Lcom/mathra/keyboard/billing/BillingRepository$launchBillingFlow$1;

    const/4 v2, 0x0

    invoke-direct {v0, p0, p2, p1, v2}, Lcom/mathra/keyboard/billing/BillingRepository$launchBillingFlow$1;-><init>(Lcom/mathra/keyboard/billing/BillingRepository;Lcom/android/billingclient/api/QueryProductDetailsParams;Landroid/app/Activity;Lkotlin/coroutines/Continuation;)V
...
.method public onPurchasesUpdated(Lcom/android/billingclient/api/BillingResult;Ljava/util/List;)V
    ...
    .line 80
    iget-object v0, p0, Lcom/mathra/keyboard/billing/BillingRepository;->scope:Lkotlinx/coroutines/CoroutineScope;

    new-instance p1, Lcom/mathra/keyboard/billing/BillingRepository$onPurchasesUpdated$1;

    const/4 v1, 0x0

    invoke-direct {p1, p2, p0, v1}, Lcom/mathra/keyboard/billing/BillingRepository$onPurchasesUpdated$1;-><init>(Ljava/util/List;Lcom/mathra/keyboard/billing/BillingRepository;Lkotlin/coroutines/Continuation;)V
...
.method public final queryPurchases()V
    ...
    .line 52
    iget-object v2, p0, Lcom/mathra/keyboard/billing/BillingRepository;->scope:Lkotlinx/coroutines/CoroutineScope;

    new-instance v1, Lcom/mathra/keyboard/billing/BillingRepository$queryPurchases$1;

    const/4 v3, 0x0

    invoke-direct {v1, p0, v0, v3}, Lcom/mathra/keyboard/billing/BillingRepository$queryPurchases$1;-><init>(Lcom/mathra/keyboard/billing/BillingRepository;Lcom/android/billingclient/api/QueryPurchasesParams;Lkotlin/coroutines/Continuation;)V
