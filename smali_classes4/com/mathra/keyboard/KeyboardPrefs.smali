.class public Lcom/mathra/keyboard/KeyboardPrefs;
...
.method public static exportSettings(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 318
    invoke-static {p0}, Lcom/mathra/keyboard/KeyboardPrefs;->prefs(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public static getThemeColors(Landroid/content/Context;)Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    .line 364
    invoke-static {p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getTheme(Landroid/content/Context;)I

    move-result v0

    invoke-static {p0, v0}, Lcom/mathra/keyboard/KeyboardPrefs;->getThemeColorsForTheme(Landroid/content/Context;I)Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;
...
.method public static getThemeColorsForTheme(Landroid/content/Context;I)Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;
    .locals 39
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 377
    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->isBorderEnabled(Landroid/content/Context;)Z
    ...
    .line 479
    :pswitch_5
    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomColorBg(Landroid/content/Context;)I

    move-result v1

    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomColorKey(Landroid/content/Context;)I

    move-result v3

    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomColorText(Landroid/content/Context;)I

    move-result v17

    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomColorAccent(Landroid/content/Context;)I

    move-result v7

    .line 480
    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomColorToolbar(Landroid/content/Context;)I

    move-result v9

    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomColorBorder(Landroid/content/Context;)I

    move-result v14

    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomColorEmoji(Landroid/content/Context;)I

    move-result v22

    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomColorClipboard(Landroid/content/Context;)I

    move-result v0

    .line 481
    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomImageUri(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v23

    .line 482
    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->getCustomImageKeyOpacity(Landroid/content/Context;)F

    move-result v12

    .line 483
    invoke-static/range {p0 .. p0}, Lcom/mathra/keyboard/KeyboardPrefs;->isCustomRgbEnabled(Landroid/content/Context;)Z
    ...
    .line 497
    :goto_9
    new-instance v0, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;

    move-object/from16 v25, v0

    invoke-direct/range {v25 .. v38}, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;-><init>(IIIIIIIIIZLjava/lang/String;FZ)V
