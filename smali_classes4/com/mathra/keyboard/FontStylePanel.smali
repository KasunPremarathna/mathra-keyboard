.class public final Lcom/mathra/keyboard/FontStylePanel;
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nFontStylePanel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 FontStylePanel.kt\ncom/mathra/keyboard/FontStylePanel\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,263:1\n1872#2,3:264\n*S KotlinDebug\n*F\n+ 1 FontStylePanel.kt\ncom/mathra/keyboard/FontStylePanel\n*L\n171#1:264,3\n*E\n"
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/mathra/keyboard/FontStylePanel;",
        "",
        "<init>",
        "()V",
        "build",
...
.field public static final INSTANCE:Lcom/mathra/keyboard/FontStylePanel;
...
.method public static synthetic $r8$lambda$NwA_tXxpFLasXbgYdAbGs7XR1Yo(Lkotlin/jvm/functions/Function0;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Lcom/mathra/keyboard/FontStylePanel;->build$lambda$4$lambda$2$lambda$1(Lkotlin/jvm/functions/Function0;Landroid/view/View;)V
...
.method public static synthetic $r8$lambda$ZJBNH8Ui7rLFwmpoFKqETNDWIU4(Landroid/content/Context;ILkotlin/jvm/functions/Function0;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/mathra/keyboard/FontStylePanel;->build$lambda$18$lambda$17$lambda$16(Landroid/content/Context;ILkotlin/jvm/functions/Function0;Landroid/view/View;)V
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/mathra/keyboard/FontStylePanel;

    invoke-direct {v0}, Lcom/mathra/keyboard/FontStylePanel;-><init>()V

    sput-object v0, Lcom/mathra/keyboard/FontStylePanel;->INSTANCE:Lcom/mathra/keyboard/FontStylePanel;
...
.method public static final synthetic access$dp(Lcom/mathra/keyboard/FontStylePanel;Landroid/content/Context;I)I
    .locals 0

    .line 15
    invoke-direct {p0, p1, p2}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
...
.method private static final build$lambda$18$lambda$17$lambda$16(Landroid/content/Context;ILkotlin/jvm/functions/Function0;Landroid/view/View;)V
    ...
    .line 232
    sget-object p3, Lcom/mathra/keyboard/EnglishFontManager;->INSTANCE:Lcom/mathra/keyboard/EnglishFontManager;

    invoke-virtual {p3, p0, p1}, Lcom/mathra/keyboard/EnglishFontManager;->setActiveStyle(Landroid/content/Context;I)V
...
# virtual methods
.method public final build(Landroid/content/Context;ILcom/mathra/keyboard/KeyboardPrefs$ThemeColors;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;)Landroid/view/View;
    .locals 23
    ...
    :goto_0
    :try_start_0
    invoke-static/range {p1 .. p1}, Lcom/mathra/keyboard/KeyboardPrefs;->getUiFontFamily(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_2
    iget v1, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->bg:I
    ...
    .line 36
    invoke-direct {v15, v7, v1}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    invoke-direct {v6, v7, v5}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    .line 41
    :cond_3
    iget v3, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->bg:I
    ...
    .line 46
    sget v3, Lcom/mathra/keyboard/R$drawable;->ic_back:I

    invoke-virtual {v1, v3}, Landroid/widget/ImageView;->setImageResource(I)V

    .line 47
    iget v3, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->accent:I
    ...
    invoke-direct {v6, v7, v4}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    .line 50
    new-instance v3, Lcom/mathra/keyboard/FontStylePanel$$ExternalSyntheticLambda0;

    invoke-direct {v3, v0}, Lcom/mathra/keyboard/FontStylePanel$$ExternalSyntheticLambda0;-><init>(Lkotlin/jvm/functions/Function0;)V
    ...
    .line 56
    iget v1, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->text:I
    ...
    .line 69
    invoke-direct {v6, v7, v0}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    .line 76
    iget v1, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->accent:I
    ...
    invoke-direct {v6, v7, v2}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    invoke-direct {v6, v7, v1}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    .line 89
    new-instance v16, Lcom/mathra/keyboard/FontStylePanel$build$2;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/mathra/keyboard/FontStylePanel$build$2;-><init>(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;ZLkotlin/jvm/functions/Function0;)V
    ...
    .line 162
    invoke-direct {v10, v7, v14}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I

    move-result v1

    const/16 v2, 0x18

    invoke-direct {v10, v7, v2}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    invoke-virtual {v0, v7}, Lcom/mathra/keyboard/EnglishFontManager;->getActiveStyle(Landroid/content/Context;)I

    move-result v0

    .line 167
    sget-object v1, Lcom/mathra/keyboard/EnglishFontManager;->INSTANCE:Lcom/mathra/keyboard/EnglishFontManager;

    invoke-virtual {v1}, Lcom/mathra/keyboard/EnglishFontManager;->getAllStyles()Ljava/util/List;
    ...
    .line 187
    invoke-direct {v10, v7, v3}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    .line 189
    invoke-direct {v10, v7, v1}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    invoke-direct {v10, v7, v6}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    .line 192
    iget v11, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->accent:I
    ...
    :cond_a
    iget v14, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->accent:I
    ...
    :cond_c
    iget v6, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->key:I
    ...
    .line 203
    sget-object v3, Lcom/mathra/keyboard/EnglishFontManager;->INSTANCE:Lcom/mathra/keyboard/EnglishFontManager;

    invoke-virtual {v3, v5}, Lcom/mathra/keyboard/EnglishFontManager;->getStyleName(I)Ljava/lang/String;
    ...
    :cond_e
    iget v3, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->text:I
    ...
    invoke-virtual {v3, v7}, Lcom/mathra/keyboard/EnglishFontManager;->getActiveStyle(Landroid/content/Context;)I
    ...
    .line 217
    sget-object v14, Lcom/mathra/keyboard/EnglishFontManager;->INSTANCE:Lcom/mathra/keyboard/EnglishFontManager;

    move/from16 v22, v0

    const-string v0, "Abc"

    invoke-virtual {v14, v7, v0}, Lcom/mathra/keyboard/EnglishFontManager;->applyStyle(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 222
    iget v0, v8, Lcom/mathra/keyboard/KeyboardPrefs$ThemeColors;->text:I
    ...
    .line 224
    invoke-direct {v10, v7, v0}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    .line 231
    new-instance v0, Lcom/mathra/keyboard/FontStylePanel$$ExternalSyntheticLambda1;

    invoke-direct {v0, v7, v5, v9}, Lcom/mathra/keyboard/FontStylePanel$$ExternalSyntheticLambda1;-><init>(Landroid/content/Context;ILkotlin/jvm/functions/Function0;)V
    ...
    invoke-direct {v5, v7, v6}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
    ...
    .line 247
    invoke-direct {v5, v7, v8}, Lcom/mathra/keyboard/FontStylePanel;->dp(Landroid/content/Context;I)I
